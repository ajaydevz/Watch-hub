...
urlpatterns = [
    ...
    path(
        "increment-cart/<int:product_id>/",
        views.increment_cartitem,
        name="increment_cartitem",
    ),
    path(
        "decrement-cart/<int:product_id>/",
        views.decrement_cartitem,
        name="decrement_cartitem",
    ),
    path(
        "remove-cart-item/<int:product_id>/",
        views.remove_cart_item,
        name="remove_cartitem",
    ),
    path("address-checkout", views.address_checkout, name="address_checkout"),
    path(
        "add-address-checkout/<int:user_id>/",
        views.add_address_checkout,
