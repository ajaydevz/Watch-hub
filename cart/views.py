    ...
    if 'useremail' in request.session:
        ...
        for cart_item in cart_items:
            ...
            if cart_item.quantity > orderproduct.stock:
                ...
                messages.error(request, f"Sorry, only {orderproduct.stock} quantity of {orderproduct.product.product_name} is available.")

                # Redirect the user to the cart or any other appropriate page
                return redirect('cart_page')  # Replace 'cart' with the actual URL name of your cart page
    ...
    if request.method == 'POST':
        ...
        for cart_item in cart_items:
            ...
            if cart_item.quantity > orderproduct.stock:
                ...
                # Redirect the user to the cart or any other appropriate page
                return redirect('cart')  # Replace 'cart' with the actual URL name of your cart page
