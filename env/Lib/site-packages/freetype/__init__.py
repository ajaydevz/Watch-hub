...
class BBox(object):
    ...
    **Note**
    ...
    xMin = property(
        lambda self: self._FT_BBox.xMin, doc="The horizontal minimum (left-most)."
    )

    yMin = property(
        lambda self: self._FT_BBox.yMin, doc="The vertical minimum (bottom-most)."
    )

    xMax = property(
        lambda self: self._FT_BBox.xMax, doc="The horizontal maximum (right-most)."
    )

    yMax = property(
        lambda self: self._FT_BBox.yMax, doc="The vertical maximum (top-most)."
    )
...
class GlyphMetrics(object):
    ...
    **Note**
    ...
    width = property(
        lambda self: self._FT_Glyph_Metrics.width, doc="""The glyph's width."""
    )

    height = property(
        lambda self: self._FT_Glyph_Metrics.height, doc="""The glyph's height."""
    )

    horiBearingX = property(
        lambda self: self._FT_Glyph_Metrics.horiBearingX,
        doc="""Left side bearing for horizontal layout.""",
    )

    horiBearingY = property(
        lambda self: self._FT_Glyph_Metrics.horiBearingY,
        doc="""Top side bearing for horizontal layout.""",
    )

    horiAdvance = property(
        lambda self: self._FT_Glyph_Metrics.horiAdvance,
        doc="""Advance width for horizontal layout.""",
    )

    vertBearingX = property(
        lambda self: self._FT_Glyph_Metrics.vertBearingX,
        doc="""Left side bearing for vertical layout.""",
    )

    vertBearingY = property(
        lambda self: self._FT_Glyph_Metrics.vertBearingY,
        doc="""Top side bearing for vertical layout. Larger positive values
                mean further below the vertical glyph origin.""",
    )

    vertAdvance = property(
        lambda self: self._FT_Glyph_Metrics.vertAdvance,
...
class SizeMetrics(object):
    ...
    **Note**
    ...
    x_ppem = property(
        lambda self: self._FT_Size_Metrics.x_ppem,
    ...
    y_ppem = property(
        lambda self: self._FT_Size_Metrics.y_ppem,
    ...
    x_scale = property(
        lambda self: self._FT_Size_Metrics.x_scale,
    ...
    y_scale = property(
        lambda self: self._FT_Size_Metrics.y_scale,
    ...
    ascender = property(
        lambda self: self._FT_Size_Metrics.ascender,
        doc="""The ascender in 26.6 fractional pixels. See Face for the
                  details.""",
    )

    descender = property(
        lambda self: self._FT_Size_Metrics.descender,
        doc="""The descender in 26.6 fractional pixels. See Face for the
                    details.""",
    )

    height = property(
        lambda self: self._FT_Size_Metrics.height,
        doc="""The height in 26.6 fractional pixels. See Face for the details.""",
    )

    max_advance = property(
        lambda self: self._FT_Size_Metrics.max_advance,
...
class Bitmap(object):
    ...
    *Note*:
    ...
    rows = property(
        lambda self: self._FT_Bitmap.rows, doc="""The number of bitmap rows."""
    )

    width = property(
        lambda self: self._FT_Bitmap.width,
        doc="""The number of pixels in bitmap row.""",
    )

    pitch = property(
        lambda self: self._FT_Bitmap.pitch,
...
class Charmap(object):
    ...
    **See also**:
    ...
    encoding = property(
        lambda self: self._FT_Charmap.contents.encoding,
        doc="""An FT_Encoding tag identifying the charmap. Use this with
                  FT_Select_Charmap.""",
    )

    platform_id = property(
        lambda self: self._FT_Charmap.contents.platform_id,
    ...
    encoding_id = property(
        lambda self: self._FT_Charmap.contents.encoding_id,
    ...
    cmap_language_id = property(
        _get_cmap_language_id,
...
class Outline(object):
    ...
    contours = property(_get_contours, doc="""The number of contours in the outline.""")
    ...
    points = property(_get_points, doc="""The number of points in the outline.""")
    ...
    flags = property(
        lambda self: self._FT_Outline.flags,
    ...
    def decompose(
        ...
        error = FT_Outline_Decompose(
            byref(self._FT_Outline), byref(func), py_object(context)
        )
        if error:
            raise FT_Exception(error)
...
class Glyph(object):
    ...
    format = property(_get_format, doc="""The format of the glyph's image.""")
    ...
    def stroke(self, stroker, destroy=False):
        ...
        **Note**:
        ...
        """
        error = FT_Glyph_Stroke(byref(self._FT_Glyph), stroker._FT_Stroker, destroy)
        if error:
            raise FT_Exception(error)
        ...
        **Note**:
        ...
        if type(origin) == FT_Vector:
            error = FT_Glyph_To_Bitmap(
                byref(self._FT_Glyph), mode, byref(origin), destroy
            )
        else:
    ...
    def get_cbox(self, bbox_mode):
        ...
        **Note**:
        ...
        """
        bbox = FT_BBox()
        error = FT_Glyph_Get_CBox(
            byref(self._FT_Glyph.contents), bbox_mode, byref(bbox)
        )
        if error:
            raise FT_Exception(error)
        return BBox(bbox)
...
class BitmapGlyph(object):
    ...
    bitmap = property(_get_bitmap, doc="""A descriptor for the bitmap.""")
...
class GlyphSlot(object):
    ...
    advance = property(
        lambda self: self._FT_GlyphSlot.contents.advance,
    ...
    format = property(
        lambda self: self._FT_GlyphSlot.contents.format,
    ...
    bitmap_top = property(
        lambda self: self._FT_GlyphSlot.contents.bitmap_top,
    ...
    bitmap_left = property(
        lambda self: self._FT_GlyphSlot.contents.bitmap_left,
        doc="""This is the bitmap's left bearing expressed in integer
                     pixels. Of course, this is only valid if the format is
                     FT_GLYPH_FORMAT_BITMAP.""",
    )

    linearHoriAdvance = property(
        lambda self: self._FT_GlyphSlot.contents.linearHoriAdvance,
    ...
    linearVertAdvance = property(
        lambda self: self._FT_GlyphSlot.contents.linearVertAdvance,
...
class Face(object):
    ...
    def set_charmap(self, charmap):
        ...
        if type(charmap) == Charmap:
            ...
            error = FT_Set_Charmap(
                self._FT_Face, self._FT_Face.contents.charmaps[charmap]
            )
        if error:
            raise FT_Exception(error)
    ...
    def get_glyph_name(self, agindex, buffer_max=64):
        ...
        error = FT_Get_Glyph_Name(
            self._FT_Face, FT_UInt(agindex), byref(buff), FT_UInt(buffer_max)
        )
        if error:
            raise FT_Exception(error)
        return buff.value
    ...
    def get_name_index(self, name):
        ...
        if not isinstance(name, bytes):
            raise FT_Exception(
                0x06,
                "FT_Get_Name_Index() expects a binary "
    ...
    def set_transform(self, matrix, delta):
        ...
        **Note**:
        ...
        """
        FT_Set_Transform(self._FT_Face, byref(matrix), byref(delta))
    ...
    def get_kerning(self, left, right, mode=FT_KERNING_DEFAULT):
        ...
        **Note**:
        ...
        error = FT_Get_Kerning(
            self._FT_Face, left_glyph, right_glyph, mode, byref(kerning)
        )
        if error:
            raise FT_Exception(error)
        return kerning
    ...
    sfnt_name_count = property(
        _get_sfnt_name_count, doc="""Number of name strings in the SFNT 'name' table."""
    )
    ...
    def get_variation_info(self):
        ...
        if version() < (2, 8, 1):
            raise NotImplementedError(
                "freetype-py VF support requires FreeType 2.8.1 or later"
            )
    ...
    def get_var_blend_coords(self):
        ...
        error = FT_Get_Var_Blend_Coordinates(
            self._FT_Face, num_coords, byref(ft_coords)
        )
    ...
    def set_var_blend_coords(self, coords, reset=False):
        ...
        if reset:
            ...
            error = FT_Set_Var_Blend_Coordinates(
                self._FT_Face, num_coords, byref(coords_array)
            )
    ...
    def get_var_design_coords(self):
        ...
        num_coords = len(vsi.axes)
        ft_coords = (FT_Fixed * num_coords)()
        error = FT_Get_Var_Design_Coordinates(
            self._FT_Face, num_coords, byref(ft_coords)
        )
    ...
    def set_var_design_coords(self, coords, reset=False):
        ...
        if reset:
            ...
            ft_coords = [int(round(c * 65536.0)) for c in coords]
            coords_array = (FT_Fixed * num_coords)(*ft_coords)
            error = FT_Set_Var_Design_Coordinates(
                self._FT_Face, num_coords, byref(coords_array)
            )
    ...
    has_vertical = property(
        _has_vertical, doc="""True whenever a face object contains vertical metrics."""
    )

    def _has_kerning(self):
        return bool(self.face_flags & FT_FACE_FLAG_KERNING)

    has_kerning = property(
        _has_kerning,
    ...
    has_multiple_masters = property(
        _has_multiple_masters,
    ...
    style_flags = property(
        lambda self: self._FT_Face.contents.style_flags,
        doc="""A set of bit flags indicating the style of the face; see
                     FT_STYLE_FLAG_XXX for the details.""",
    )

    num_glyphs = property(
        lambda self: self._FT_Face.contents.num_glyphs,
    ...
    family_name = property(
        lambda self: self._FT_Face.contents.family_name,
    ...
    style_name = property(
        lambda self: self._FT_Face.contents.style_name,
    ...
    num_fixed_sizes = property(
        lambda self: self._FT_Face.contents.num_fixed_sizes,
    ...
    charmaps = property(_get_charmaps, doc="""A list of the charmaps of the face.""")
    ...
    units_per_EM = property(
        lambda self: self._FT_Face.contents.units_per_EM,
    ...
    ascender = property(
        lambda self: self._FT_Face.contents.ascender,
    ...
    descender = property(
        lambda self: self._FT_Face.contents.descender,
    ...
    height = property(
        lambda self: self._FT_Face.contents.height,
        doc="""The height is the vertical distance between two consecutive
                baselines, expressed in font units. It is always positive. Only
                relevant for scalable formats.""",
    )

    max_advance_width = property(
        lambda self: self._FT_Face.contents.max_advance_width,
    ...
    max_advance_height = property(
        lambda self: self._FT_Face.contents.max_advance_height,
    ...
    underline_position = property(
        lambda self: self._FT_Face.contents.underline_position,
    ...
    underline_thickness = property(
        lambda self: self._FT_Face.contents.underline_thickness,
    ...
    glyph = property(_get_glyph, doc="""The face's associated glyph slot(s).""")
    ...
    size = property(_get_size, doc="""The current active size for this face.""")

    def _get_charmap(self):
        return Charmap(self._FT_Face.contents.charmap)

    charmap = property(
        _get_charmap, doc="""The current active charmap for this face."""
    )
...
class SfntName(object):
    ...
    platform_id = property(
        lambda self: self._FT_SfntName.platform_id,
        doc="""The platform ID for 'string'.""",
    )

    encoding_id = property(
        lambda self: self._FT_SfntName.encoding_id,
        doc="""The encoding ID for 'string'.""",
    )

    language_id = property(
        lambda self: self._FT_SfntName.language_id,
        doc="""The language ID for 'string'.""",
    )

    name_id = property(
        lambda self: self._FT_SfntName.name_id, doc="""An identifier for 'string'."""
    )

    # string      = property(lambda self: self._FT_SfntName.string)

    string_len = property(
        lambda self: self._FT_SfntName.string_len,
...
class Stroker(object):
    ...
    def set(self, radius, line_cap, line_join, miter_limit):
        ...
        **Note**:
        ...
        """
        FT_Stroker_Set(self._FT_Stroker, radius, line_cap, line_join, miter_limit)
    ...
    def parse_outline(self, outline, opened):
        ...
        **Note**:
        ...
        """
        error = FT_Stroker_ParseOutline(
            self._FT_Stroker, byref(outline._FT_Outline), opened
        )
        if error:
            raise FT_Exception(error)
    ...
    def get_border_counts(self, border):
        ...
        error = FT_Stroker_GetBorderCounts(
            self._FT_Stroker, border, byref(anum_points), byref(anum_contours)
        )
        if error:
            raise FT_Exception(error)
    ...
    def get_counts(self):
        ...
        anum_points = FT_UInt()
        anum_contours = FT_UInt()
        error = FT_Stroker_GetCounts(
            self._FT_Stroker, byref(anum_points), byref(anum_contours)
        )
        if error:
            raise FT_Exception(error)
        return anum_points.value, anum_contours.value
