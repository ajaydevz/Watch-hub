...
class ConfigurableMixin:
    ...
    def _process_configurable_fields(cls, config_dict):
        ...
        for f in dataclasses.fields(cls):
            ...
            if field_type is None or not issubclass(field_type, ConfigurableMixin):
                continue
    ...
    def from_config(cls, config_dict):
        ...
        config_dict = {key.replace("-", "_"): v for key, v in config_dict.items()}
...
def process_oid(asn1crypto_class: Type[ObjectIdentifier], id_string, param_name):
...
def _ensure_strings(strings, param_name):
    err_msg = f"'{param_name}' must be specified as a " "list of strings, or a string."
...
def process_bit_string_flags(asn1crypto_class: Type[BitString], strings, param_name):
    strings = _ensure_strings(strings, param_name)
