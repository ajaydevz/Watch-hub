...
class AxisAlignment(enum.Enum):
    ...
    def align(self, container_len: int, inner_len: int, pre_margin, post_margin) -> int:
...
class Margins(ConfigurableMixin):
    ...
    def from_config(cls, config_dict):
        ...
        if isinstance(config_dict, list):
            config_dict = dict(zip(("left", "right", "top", "bottom"), config_dict))
...
class SimpleBoxLayoutRule(ConfigurableMixin):
    ...
    def process_entries(cls, config_dict):
        ...
        if scaling is not None:
            config_dict["inner_content_scaling"] = InnerScaling.from_config(scaling)
    ...
    def fit(
        ...
        if (
            ...
            x_scale = (eff_width / inner_nat_width) if inner_nat_width != 0 else 1
            y_scale = (eff_height / inner_nat_height) if inner_nat_height != 0 else 1
        ...
        return Positioning(x_pos=x_pos, y_pos=y_pos, x_scale=x_scale, y_scale=y_scale)
