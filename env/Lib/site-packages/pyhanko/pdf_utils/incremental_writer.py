...
class IncrementalPdfFileWriter(BasePdfFileWriter):
    ...
    def __init__(self, input_stream, prev: Optional[PdfFileReader] = None, strict=True):
    ...
    def get_object(self, ido, as_metadata_stream: bool = False):
        try:
            return super().get_object(ido, as_metadata_stream=as_metadata_stream)
        except KeyError:
            return self.prev.get_object(ido, as_metadata_stream=as_metadata_stream)
    ...
    def _write_header(self, stream):
        ...
        misc.chunked_write(bytearray(self.IO_CHUNK_SIZE), self.input_stream, stream)
    ...
    def _populate_trailer(self, trailer):
        ...
        trailer[pdf_name("/Prev")] = generic.NumberObject(self.prev.last_startxref)
