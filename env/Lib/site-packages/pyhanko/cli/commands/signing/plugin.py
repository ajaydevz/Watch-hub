...
def _ensure_field_visible(handler: PdfHandler, name: Optional[str], will_create: bool):
...
def _callback_logic(plugin: SigningCommandPlugin, infile: str, outfile: str, **kwargs):
    ...
    with plugin.create_signer(cli_ctx, **kwargs) as signer:
        ...
        if pdf_sig_settings is None:
            ...
            with open_for_signing(infile_path=infile, lenient=cli_ctx.lenient) as w:
