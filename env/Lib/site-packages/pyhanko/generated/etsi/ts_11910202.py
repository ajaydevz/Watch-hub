...
class ValidationReportDataType:
    ...
    revocation_status_information: Optional[RevocationStatusInformationType] = field(
        default=None,
        metadata={
...
class ValidationStatusType:
    ...
    associated_validation_report_data: Tuple[ValidationReportDataType, ...] = field(
        default_factory=tuple,
        metadata={
...
class SignatureAttributesType:
    ...
    commitment_type_indication: Tuple[SACommitmentTypeIndicationType, ...] = field(
        default_factory=tuple,
        metadata={
    ...
    signature_production_place: Tuple[SASignatureProductionPlaceType, ...] = field(
        default_factory=tuple,
        metadata={
...
class ValidationConstraintsEvaluationReportType:
    signature_validation_policy: Optional[SignatureValidationPolicyType] = field(
        default=None,
        metadata={
    ...
    validation_constraint: Tuple[IndividualValidationConstraintReportType, ...] = field(
        default_factory=tuple,
        metadata={
...
class SignatureValidationReportType:
    ...
    signature_validation_process: Optional[SignatureValidationProcessType] = field(
        default=None,
        metadata={
...
class ValidationReportType:
    signature_validation_report: Tuple[SignatureValidationReportType, ...] = field(
        default_factory=tuple,
        metadata={
