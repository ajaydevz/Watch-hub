...
try:
    ...
    advapi32.CryptGenKey.argtypes = [HCRYPTPROV, ALG_ID, DWORD, POINTER(HCRYPTKEY)]
    ...
    advapi32.CryptSetKeyParam.argtypes = [HCRYPTKEY, DWORD, c_void_p, DWORD]
    ...
    advapi32.CryptHashData.argtypes = [HCRYPTHASH, PBYTE, DWORD, DWORD]
    advapi32.CryptHashData.restype = BOOL

    advapi32.CryptSetHashParam.argtypes = [HCRYPTHASH, DWORD, PBYTE, DWORD]
