...
def dump_private_key(private_key, passphrase, encoding="pem", target_ms=200):
    ...
    if passphrase is not None:
        ...
        iterations = pbkdf2_iteration_calculator(
                ...
                "encryption_algorithm": {
                    ...
                    "parameters": {
                        "key_derivation_func": {
                            "algorithm": "pbkdf2",
                            "parameters": {
                                "salt": Pbkdf2Salt(name="specified", value=kdf_salt),
                                "iteration_count": iterations,
                                "prf": {"algorithm": kdf_hmac, "parameters": Null()},
                            },
                        },
                        "encryption_scheme": {"algorithm": cipher, "parameters": iv},
                    },
                },
