...
if version_info < (10, 7):
    raise OSError(
        "Only OS X 10.7 and newer are supported, not %s.%s"
...
class CSSM_DATA(Structure):  # noqa
    _fields_ = [("Length", c_uint32), ("Data", c_char_p)]
...
try:
    ...
    Security.SecTrustSetPolicies.argtypes = [SecTrustRef, CFArrayRef]
    ...
    Security.SecPolicySetValue.argtypes = [SecPolicyRef, POINTER(CSSM_DATA)]
    ...
    setattr(
        Security, "SecItemImportExportKeyParameters", SecItemImportExportKeyParameters
    )

    setattr(
        Security,
        "kSecRandomDefault",
        SecRandomRef.in_dll(Security, "kSecRandomDefault"),
    )
    ...
    setattr(
        Security,
        "kSecPaddingPKCS7Key",
        CFStringRef.in_dll(Security, "kSecPaddingPKCS7Key"),
    )
    setattr(
        Security,
        "kSecPaddingPKCS5Key",
        CFStringRef.in_dll(Security, "kSecPaddingPKCS5Key"),
    )
    setattr(
        Security,
        "kSecPaddingPKCS1Key",
        CFStringRef.in_dll(Security, "kSecPaddingPKCS1Key"),
    )
    setattr(
        Security,
        "kSecPaddingOAEPKey",
        CFStringRef.in_dll(Security, "kSecPaddingOAEPKey"),
    )
    setattr(
        Security,
        "kSecPaddingNoneKey",
        CFStringRef.in_dll(Security, "kSecPaddingNoneKey"),
    )
    ...
    setattr(
        ...
        CFStringRef.in_dll(Security, "kSecDigestTypeAttribute"),
    )
    setattr(
        Security,
        "kSecDigestLengthAttribute",
        CFStringRef.in_dll(Security, "kSecDigestLengthAttribute"),
    )
    ...
    setattr(
        ...
        CFStringRef.in_dll(Security, "kSecAttrIsExtractable"),
    )
    ...
    setattr(
        Security, "kSecAttrKeyType", CFStringRef.in_dll(Security, "kSecAttrKeyType")
    )

    setattr(
        Security, "kSecAttrKeyTypeRSA", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeRSA")
    )
    setattr(
        Security, "kSecAttrKeyTypeDSA", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeDSA")
    )
    setattr(
        Security,
        "kSecAttrKeyTypeECDSA",
        CFTypeRef.in_dll(Security, "kSecAttrKeyTypeECDSA"),
    )

    setattr(
        Security,
        "kSecAttrKeySizeInBits",
        CFStringRef.in_dll(Security, "kSecAttrKeySizeInBits"),
    )
    ...
    setattr(
        Security, "kSecAttrCanVerify", CFTypeRef.in_dll(Security, "kSecAttrCanVerify")
    )

    setattr(
        Security, "kSecAttrKeyTypeAES", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeAES")
    )
    setattr(
        Security, "kSecAttrKeyTypeRC4", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeRC4")
    )
    setattr(
        Security, "kSecAttrKeyTypeRC2", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeRC2")
    )
    setattr(
        Security,
        "kSecAttrKeyType3DES",
        CFTypeRef.in_dll(Security, "kSecAttrKeyType3DES"),
    )
    setattr(
        Security, "kSecAttrKeyTypeDES", CFTypeRef.in_dll(Security, "kSecAttrKeyTypeDES")
    )
