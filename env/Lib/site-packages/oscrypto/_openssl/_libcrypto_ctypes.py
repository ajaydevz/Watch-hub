...
try:
    ...
    libcrypto.i2d_PUBKEY.argtypes = [P_EVP_PKEY, POINTER(c_char_p)]
    ...
    if version_info < (1, 1):
        ...
        libcrypto.EVP_MD_CTX_free.argtypes = [P_EVP_MD_CTX]
    ...
    if version_info < (3, 0):
        ...
        libcrypto.EVP_PKEY_get_size.argtypes = [P_EVP_PKEY]
    ...
    libcrypto.DH_generate_parameters_ex.argtypes = [P_DH, c_int, c_int, P_BN_GENCB]
    libcrypto.DH_generate_parameters_ex.restype = c_int

    libcrypto.i2d_DHparams.argtypes = [P_DH, POINTER(c_char_p)]
    libcrypto.i2d_DHparams.restype = c_int

    libcrypto.DH_free.argtypes = [P_DH]
