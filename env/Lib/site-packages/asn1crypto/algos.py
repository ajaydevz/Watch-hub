...
class RSAESOAEPParams(Sequence):
    _fields = [
        (
            "hash_algorithm",
            DigestAlgorithm,
            {"explicit": 0, "default": {"algorithm": "sha1"}},
        ),
        (
            "mask_gen_algorithm",
            MaskGenAlgorithm,
            {
                "explicit": 1,
                "default": {"algorithm": "mgf1", "parameters": {"algorithm": "sha1"}},
            },
        ),
        (
            "p_source_algorithm",
            PSourceAlgorithm,
            {"explicit": 2, "default": {"algorithm": "p_specified", "parameters": b""}},
        ),
    ]
...
class EncryptionAlgorithm(_ForceNullParameters, Sequence):
    ...
    def kdf_hmac(self):
        ...
        if encryption_algo == "pbes2":
            return self["parameters"]["key_derivation_func"]["parameters"]["prf"][
                "algorithm"
            ].native
    ...
    def kdf_iterations(self):
        ...
        if encryption_algo == "pbes2":
            return self["parameters"]["key_derivation_func"]["parameters"][
                "iteration_count"
            ].native
    ...
    def key_length(self):
        ...
        if encryption_algo == "pbes2":
            key_length = self["parameters"]["key_derivation_func"]["parameters"][
                "key_length"
            ].native
