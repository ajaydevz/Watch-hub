...
class ThumbnailerFieldTest(AliasBaseTest):
    ...
    def test_generate_thumbnail_bad_image(self):
        ...
        generate = lambda: instance.avatar.generate_thumbnail({"size": (300, 300)})
    ...
    def test_generate_thumbnail_alias_0x0_size(self):
        instance = models.TestModel(avatar="avatars/avatar.jpg")
        self.assertRaises(
            EasyThumbnailsError, instance.avatar.generate_thumbnail, {"size": (0, 0)}
        )
    ...
    def test_serialization(self):
        instance = models.TestModel(avatar="avatars/avatar.jpg")
        self.assertEqual(
            "/media/avatars/avatar.jpg.100x100_q85.jpg", instance.avatar["small"].url
        )
        new_instance = pickle.loads(pickle.dumps(instance))
        self.assertEqual(
            "/media/avatars/avatar.jpg.100x100_q85.jpg",
            new_instance.avatar["small"].url,
        )
