...
class PilImageTest(test.BaseTest):
    def test_not_image(self):
        ...
        """
        self.assertRaises(
            IOError, source_generators.pil_image, BytesIO(b"not an image")
        )
    ...
    def test_exif_orientation(self):
        ...
        for exif_orientation, data in EXIF_ORIENTATION.items():
            ...
            self.assertTrue(
                ...
                "EXIF orientation %s did not match reference image" % exif_orientation,
            )
    ...
    def test_switch_off_exif_orientation(self):
        ...
        self.assertFalse(
            near_identical(reference, im), "Image should not have been modified"
        )
