...
class ValidationPath:
    ...
    def truncate_to_and_append(self, cert: x509.Certificate, new_leaf: Leaf):
        ...
        return ValidationPath(self._root, interm=certs[: cert_index + 1], leaf=new_leaf)
    ...
    def copy_and_append(self, cert: Leaf):
        ...
        return ValidationPath(trust_anchor=self._root, interm=new_certs, leaf=cert)
    ...
    def copy_and_drop_leaf(self) -> "ValidationPath":
        ...
        return ValidationPath(trust_anchor=self._root, interm=new_interm, leaf=new_leaf)
