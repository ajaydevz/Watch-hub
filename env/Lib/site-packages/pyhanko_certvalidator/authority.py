...
class TrustAnchor:
    ...
    def __init__(self, authority: Authority, quals: Optional[TrustQualifiers] = None):
    ...
    def __eq__(self, other):
        return isinstance(other, TrustAnchor) and other._authority == self._authority
...
def derive_quals_from_cert(cert: x509.Certificate) -> TrustQualifiers:
    ...
    if ext_found:
        params = PKIXValidationParams(
            user_initial_policy_set=(acceptable_policies or frozenset(["any_policy"])),
