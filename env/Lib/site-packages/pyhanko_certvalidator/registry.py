...
class CertificateRegistry(SimpleCertificateStore):
    ...
    async def fetch_missing_potential_issuers(self, cert: x509.Certificate):
        ...
        issuers = [issuer async for issuer in self.fetcher.fetch_cert_issuers(cert)]
...
class PathBuilder:
    ...
    def __init__(self, trust_manager: TrustManager, registry: CertificateRegistry):
...
class _IssuerFetcher:
    def __init__(
        ...
        self._fetched_cas: Optional[AsyncGenerator[x509.Certificate, None]] = None
    ...
    async def __anext__(self) -> Union[TrustAnchor, x509.Certificate]:
        ...
        if (
            ...
            self._fetched_cas = (
                self.path_builder.registry.fetch_missing_potential_issuers(self.cert)
            )
