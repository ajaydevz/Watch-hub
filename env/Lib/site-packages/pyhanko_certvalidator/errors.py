...
class PathValidationError(ValidationError):
    @classmethod
    def from_state(cls: Type[TPathErr], msg: str, proc_state: ValProcState) -> TPathErr:
...
class StaleRevinfoError(InsufficientRevinfoError):
    ...
    def __init__(self, msg: str, time_cutoff: datetime, proc_state: ValProcState):
...
class DisallowedAlgorithmError(PathValidationError):
    def __init__(self, *args, banned_since: Optional[datetime] = None, **kwargs):
