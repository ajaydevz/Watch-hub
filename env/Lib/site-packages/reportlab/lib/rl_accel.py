...
if "instanceStringWidthT1" in _py_funcs:
    ...
    def instanceStringWidthT1(self, text, size, encoding="utf8"):
        ...
        return (
            sum(
                (
                    sum(map(f.widths.__getitem__, t))
...
if "asciiBase85Encode" in _py_funcs:
    ...
    def asciiBase85Encode(input):
        ...
        if remainder_size > 0:
            ...
            lastword = (
                chr(c1 + 33) + chr(c2 + 33) + chr(c3 + 33) + chr(c4 + 33) + chr(c5 + 33)
            )
...
if "asciiBase85Decode" in _py_funcs:
    ...
    def asciiBase85Decode(input):
        ...
        for i in range(whole_word_count):
            ...
            num = (
                ((85**4) * c1) + ((85**3) * c2) + ((85**2) * c3) + (85 * c4) + c5
            )
...
if __name__ == "__main__":
    ...
    for cmd, xs in (
        (
            "instanceStringWidthTTF(font,text,10)",
            ("font=TTFont('Vera','Vera.ttf')", "text='abcde fghi . jkl ; mno'"),
        ),
        (
        ...
        (
            "asciiBase85Decode(_85text)",
            ("_85text=asciiBase85Encode(5*' abcdefgiijklMnoPQrstuvwxyz1234567890')",),
        ),
    ):
