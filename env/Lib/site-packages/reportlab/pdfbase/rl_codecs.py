...
class RL_Codecs:
    ...
    def _makeCodecInfo(name, encoding_map, decoding_map):
        ...
        class Codec(codecs.Codec):
            def encode(
                ...
                input,
                errors="strict",
                charmap_encode=codecs.charmap_encode,
            ...
            def decode(
                ...
                input,
                errors="strict",
                charmap_decode=codecs.charmap_decode,
    ...
    def __rl_codecs(
        name,
        cache=__rl_codecs_cache,
        data=__rl_codecs_data,
        extension_codecs=__rl_extension_codecs,
        _256=True,
    ):
        try:
            return cache[name]
            ...
            if name in extension_codecs:
                ...
                e, r = data[name]
            cache[name] = c = (
                RL_Codecs._256_exception_codec(name, e, r)
                if _256
                else RL_Codecs._makeCodecInfo(name, e, r or {})
            )
        return c
