...
widthsByFontGlyph = {
    "Courier": reportlab.pdfbase._fontdata_widths_courier.widths,
    "Courier-Bold": reportlab.pdfbase._fontdata_widths_courierbold.widths,
    "Courier-Oblique": reportlab.pdfbase._fontdata_widths_courieroblique.widths,
    "Courier-BoldOblique": reportlab.pdfbase._fontdata_widths_courierboldoblique.widths,
    "Helvetica": reportlab.pdfbase._fontdata_widths_helvetica.widths,
    "Helvetica-Bold": reportlab.pdfbase._fontdata_widths_helveticabold.widths,
    "Helvetica-Oblique": reportlab.pdfbase._fontdata_widths_helveticaoblique.widths,
    "Helvetica-BoldOblique": reportlab.pdfbase._fontdata_widths_helveticaboldoblique.widths,
    "Times-Roman": reportlab.pdfbase._fontdata_widths_timesroman.widths,
    "Times-Bold": reportlab.pdfbase._fontdata_widths_timesbold.widths,
    "Times-Italic": reportlab.pdfbase._fontdata_widths_timesitalic.widths,
    "Times-BoldItalic": reportlab.pdfbase._fontdata_widths_timesbolditalic.widths,
    "Symbol": reportlab.pdfbase._fontdata_widths_symbol.widths,
    "ZapfDingbats": reportlab.pdfbase._fontdata_widths_zapfdingbats.widths,
}
