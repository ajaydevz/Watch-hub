...
class XPreformatted(Paragraph):
    def __init__(
        self, text, style, bulletText=None, frags=None, caseSensitive=1, dedent=0
    ):
        ...
        if nFrags == 1:
            ...
            if hasattr(f, "text"):
                ...
                for l in L:
                    ...
                    lineno = lineno + 1
                    maxWidth = (
                        lineno < len(maxWidths) and maxWidths[lineno] or maxWidths[-1]
                    )
                blPara = f.clone(
                    kind=kind,
                    lines=lines,
...
class PythonPreformatted(XPreformatted):
    ...
    def __init__(self, text, style, bulletText=None, dedent=0, frags=None):
        ...
        XPreformatted.__init__(
            self, text, style, bulletText=bulletText, dedent=dedent, frags=frags
        )
