...
class EventCalendar(Widget):
    ...
    def getRelevantTalks(self, talkList):
        ...
        for talk in talkList:
            ...
            if day == self.day:
                if (
                    (self.startTime is None) or ((hours + duration) >= self.startTime)
    ...
    def draw(self):
        ...
        g.add(
            Rect(
                ...
                self.y,
                self._colWidths[0],
                self.height - self.trackRowHeight,
...
def test():
    ...
    cal.data = [
        ...
        (
            ...
            "Nicolai Josuttis & David Vandevoorde",
            3,
            2,
            14.0,
            1.5,
        ...
        (
            ...
            "Francis Glassborow and friends",
            3,
            5,
            14.0,
            1.5,
