...
class Flag(_Symbol):
    ...
    def _borderDraw(self, f):
        ...
        g.insert(
            ...
            Rect(
                -sW,
                -sW,
                width=getattr(self, "_width", 2 * s) + 3 * sW,
                height=getattr(self, "_height", s) + 2 * sW,
                fillColor=None,
                strokeColor=self.strokeColor,
                strokeWidth=sW * 2,
            ),
    ...
    def _Flag_Cuba(self):
        ...
        box = Rect(
            0, 0, s * 2, s, fillColor=None, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_Denmark(self):
        ...
        box = Rect(
            0, 0, w, s, fillColor=colors.red, strokeColor=colors.black, strokeWidth=0
        )
        g.add(box)
    ...
    def _Flag_Japan(self):
        ...
        g.add(
            Rect(
                0, 0, w, s, fillColor=colors.mintcream, strokeColor=None, strokeWidth=0
            )
        )
        g.add(
            Circle(
    ...
    def _Flag_EU(self):
        ...
        g.add(
            Rect(0, 0, w, s, fillColor=colors.darkblue, strokeColor=None, strokeWidth=0)
        )
        centerx = w / 2.0
        centery = s / 2.0
        radius = s / 3.0
    ...
    for name in flags:
        ...
        if (i % 2 and y < 0) or name == flags[-1]:
            renderPDF.drawToFile(
                D, "flags%02d.pdf" % f, "flags.py - Page #%d" % (f + 1)
            )
            y = Y0
            f = f + 1
            D = None
