...
class DotBox(Widget):
    ...
    _attrMap = AttrMap(
        ...
        labelOffset=AttrMapValue(
            isNumber, desc="Space between label text and grid edge"
        ),
        strokeWidth=AttrMapValue(isNumber, desc="Width of the grid and dot outline"),
        gridDivWidth=AttrMapValue(isNumber, desc="Width of each 'box'"),
        gridColor=AttrMapValue(isColor, desc="Colour for the box and gridding"),
        dotDiameter=AttrMapValue(
            isNumber, desc="Diameter of the circle used for the 'dot'"
        ),
        dotColor=AttrMapValue(isColor, desc="Colour of the circle on the box"),
        dotXPosition=AttrMapValue(isNumber, desc="X Position of the circle"),
        dotYPosition=AttrMapValue(isNumber, desc="X Position of the circle"),
        x=AttrMapValue(isNumber, desc="X Position of dotbox"),
        y=AttrMapValue(isNumber, desc="Y Position of dotbox"),
    )
