...
class PlotArea(Widget):
    ...
    _attrMap = AttrMap(
        x=AttrMapValue(
            isNumber, desc="X position of the lower-left corner of the chart."
        ),
        y=AttrMapValue(
            isNumber, desc="Y position of the lower-left corner of the chart."
        ),
        ...
        background=AttrMapValue(
            isNoneOrShape,
            desc="Handle to background object e.g. Rect(0,0,width,height).",
        ),
