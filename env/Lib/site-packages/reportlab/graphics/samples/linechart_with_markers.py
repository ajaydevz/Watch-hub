...
class LineChartWithMarkers(_DrawingEditorMixin, Drawing):
    def __init__(self, width=200, height=150, *args, **kw):
        ...
        self.chart.data = [
            ((0, 50), (100, 100), (200, 200), (250, 210), (300, 300), (400, 500)),
            ((0, 150), (100, 200), (200, 300), (250, 200), (300, 400), (400, 600)),
        ]
...
if __name__ == "__main__":  # NORUNTESTS
    LineChartWithMarkers().save(
        formats=["pdf"], outDir=None, fnRoot="linechart_with_markers"
    )
