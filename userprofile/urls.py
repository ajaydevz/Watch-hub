...
urlpatterns = [
    path(
        "edit-profile/<int:user_id>/", views.EditUserProfile, name="edit_user_profile"
    ),
    ...
    path(
        "user-delete-address/<int:address_id>/",
        views.DeleteAddress,
        name="delete_address",
    ),
    ...
    path(
        "order-cancellation/<int:order_id>/",
        views.OrderCancellation,
